...
tickest_per_drawing = 100 #variable
num_drawings = 15600 #variable
...
for drawing in range(num_drawings):
	...
	for tickets in range(tickest_per_drawing):
		total_spent += 2
		my_whites = set(random.sample(white_possibles, k=5))
		my_reds = random.choice(red_possibles)

		my_numbers = {"whites": my_whites, "red": my_reds}
